function fcn_AVAR_plotCompareAvar(name_method1,avar_method1,name_method2,...
                                  avar_method2,list_of_correlation_time,...
                                  varargin)
%% fcn_AVAR_plotCompareAvar
%   This function plots AVAR of noise signal computed by two different
%   methods or AVAR of two different noise signals.
%
% FORMAT:
%   fcn_AVAR_plotCompareAvar(name_method1,avar_method1,name_method2,...
%                            avar_method2,list_of_correlation_time)
%
% INPUTS:
...
plot(list_of_correlation_time,avar_method1,'b','Linewidth',1.2)
hold on
plot(list_of_correlation_time,avar_method2,'r--','Linewidth',1.2)
grid on
